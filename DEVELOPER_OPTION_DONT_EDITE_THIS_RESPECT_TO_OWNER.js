...
module.exports = {
    ...
    DEVELOPER_TAG: process.env.DEVELOPE_TAG === undefined ? 'Public-BOt®️' : process.env.DEVELOPE_TAG,
    DEVELOPER_STATUS : process.env.DEVELOPER_STATUS === undefined ? '🤖ᴾᴼᵂᴱᴿᴱᴰ ᴮʸ Public-BOt®️' : process.env.DEVELOPER_STATUS,
