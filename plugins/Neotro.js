...
const ONO = ".tagall *😈☠Public-BOt®️ We are Deamons Do not run away...😈😈😈*"
...
Amazone.addCommand({pattern: 'botbg ?(.*)', fromMe: true, desc: UUU, dontAddCommandList: true}, (async (message, match) => {    
        if (match[1] == '') {
            await message.client.toggleDisappearingMessages(message.jid, 0);
            await message.client.sendMessage(message.jid,DDO,MessageType.text);
            await message.client.sendMessage(message.jid,DDO,MessageType.text);
