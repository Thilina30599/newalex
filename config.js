...
module.exports = {
    ...
    CAPTIONS: process.env.CAPTIONS === undefined ? 'Made By Public-BOt®️' : process.env.CAPTIONS,
    ...
    AMAZONE: process.env.AMAZONE === undefined ? 'Public-BOt®️' : process.env.AMAZONE,
    KTB: process.env.TAG_HEADER === undefined ? 'Public-BOt®️' : process.env.TAG_HEADER,
    ...
    PANEL_COMMAND: process.env.PANEL_COMMAND === undefined ? 'pubot' : process.env.PANEL_COMMAND,
    BUG_COMMAND: process.env.BUG_COMMAND === undefined ? 'pubug' : process.env.BUG_COMMAND,
